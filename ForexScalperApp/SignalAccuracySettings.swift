...
struct SignalAccuracyConfiguration: Sendable, Equatable {
    ...
    var divergenceRSIThreshold: Double = 0.0
    ...
    var reversalATRBodyFraction: Double = 0.08
    var reversalMinimumATRDivisor: Double = 20.0
    var reversalStructureToleranceATR: Double = 0.05
    ...
    static func load(from defaults: UserDefaults = .standard) -> SignalAccuracyConfiguration {
        ...
        c.divergenceRSIThreshold = double(defaults, "signalAccuracy.divergenceRSIThreshold", c.divergenceRSIThreshold)
        ...
        c.reversalATRBodyFraction = max(0, double(defaults, "signalAccuracy.reversalATRBodyFraction", c.reversalATRBodyFraction))
        c.reversalMinimumATRDivisor = max(1, double(defaults, "signalAccuracy.reversalMinimumATRDivisor", c.reversalMinimumATRDivisor))
        c.reversalStructureToleranceATR = max(0, double(defaults, "signalAccuracy.reversalStructureToleranceATR", c.reversalStructureToleranceATR))
        return c
    }
    ...
    func save(to defaults: UserDefaults = .standard) {
        ...
        defaults.set(divergenceRSIThreshold, forKey: "signalAccuracy.divergenceRSIThreshold")
        ...
        defaults.set(reversalATRBodyFraction, forKey: "signalAccuracy.reversalATRBodyFraction")
        defaults.set(reversalMinimumATRDivisor, forKey: "signalAccuracy.reversalMinimumATRDivisor")
        defaults.set(reversalStructureToleranceATR, forKey: "signalAccuracy.reversalStructureToleranceATR")
    }
}
